...
#define DEBUG 0 //If you want to debug.
...
#define STATISTICS 0 //If you want to show statistics about runtime. This doesn't check if OUTPUT globals are on or off. 
